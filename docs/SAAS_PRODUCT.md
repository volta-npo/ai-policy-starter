...
- High-risk use cases governed
- Staff acknowledgement coverage
- Prohibited-use blocks
- Human-review coverage
- Policy refresh readiness

### Onboarding milestones
- Inventory AI use cases
- Classify data and risk levels
- Define allowed/prohibited uses
- Approve human-review rules
- Export staff checklist
- Collect acknowledgement plan
...
- Staff checklist is owner-approved
- Data classes map to review rules

### Expansion motions
- Department policy addenda
- Quarterly AI use recertification
- Staff training campaign
