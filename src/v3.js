export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Small Business AI Policy Builder",
        "Operational table: AI use cases",
    ...
    "releaseChecklist": [
        ...
        "Policy Coverage reaches production threshold",
        "Data Risk is documented with evidence",
        "Human Review Coverage has no unresolved blocker",
        "AI policy verified",
        "Staff checklist verified",
        "Rules JSON verified"
    ],
    "operations": [
