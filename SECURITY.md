# Security Policy: AI Policy Starter
...
- For this product's domain, review these gates before handoff: Use case owner required, Private data rules required, Prohibited-use acknowledgement required.
